...
('Enable Structured Data generation', 'PLUGIN_SDATA_ENABLE', 'false', 'Enable the Structured Data plugin code', @configuration_group_id, 1, NOW(), NULL, 'zen_cfg_select_option(array(\'true\', \'false\'),'),
...
('Logo (Schema)', 'PLUGIN_SDATA_LOGO', '', 'Enter the complete url to your logo image.', @configuration_group_id, 10, NOW(), NULL, NULL),
...
('Phone (Schema)', 'PLUGIN_SDATA_TELEPHONE', '', 'Enter the Customer Cervice phone number in international format eg.: +1-330-871-4357. The format (spaces/dashes) is not important.', @configuration_group_id, 17, NOW(), NULL, NULL),
...
('Locales (OG)', 'PLUGIN_SDATA_FOG_LOCALES', '', 'Enter a comma-separated list of the database language_id and equivalent locale for each defined language eg.: 1,en_GB,2,es_ES, etc. (no spaces).<br>Separate the parameters with commas.', @configuration_group_id, 22, NOW(), NULL, NULL),
...
('Currency (Schema/OG)', 'PLUGIN_SDATA_PRICE_CURRENCY', '', 'Enter the currency code of the product price eg.: EUR.', @configuration_group_id, 24, NOW(), NULL, NULL),
